...
@interface k1509_InfoApp_McKinney_SequesterObject : KrollCoverageObject {
#else
@interface k1509_InfoApp_McKinney_SequesterObject : KrollObject {
#endif
@private
...
extern NSString * k1509_InfoApp_McKinney_Sequester$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	k1509_InfoApp_McKinney_SequesterObject *_k1509_infoapp_mckinney_sequester;
    KrollObject* console;
	BOOL shutdown;
