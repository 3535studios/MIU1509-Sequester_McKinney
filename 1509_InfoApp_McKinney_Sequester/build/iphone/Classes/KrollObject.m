...
//@interface k1509_InfoApp_McKinney_SequesterObject : NSObject
//@end

@interface k1509_InfoApp_McKinney_SequesterObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[k1509_InfoApp_McKinney_SequesterObject class]])
		{
			for (NSString *key in [[(k1509_InfoApp_McKinney_SequesterObject*)o modules] allKeys])
			{
