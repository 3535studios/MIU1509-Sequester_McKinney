...
// in simulator we redefine to format for k1509_InfoApp_McKinney_Sequester Developer console
...
{\
	NSString * exceptionName = [@"org.k1509_infoapp_mckinney_sequester." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.k1509_infoapp_mckinney_sequester";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIk1509_InfoApp_McKinney_SequesterNativeItemNone = -1, 
	UIk1509_InfoApp_McKinney_SequesterNativeItemSpinner = -2,
	UIk1509_InfoApp_McKinney_SequesterNativeItemProgressBar = -3,
	
	UIk1509_InfoApp_McKinney_SequesterNativeItemSlider = -4,
	UIk1509_InfoApp_McKinney_SequesterNativeItemSwitch = -5,
	UIk1509_InfoApp_McKinney_SequesterNativeItemMultiButton = -6,
	UIk1509_InfoApp_McKinney_SequesterNativeItemSegmented = -7,
	
	UIk1509_InfoApp_McKinney_SequesterNativeItemTextView = -8,
	UIk1509_InfoApp_McKinney_SequesterNativeItemTextField = -9,
	UIk1509_InfoApp_McKinney_SequesterNativeItemSearchBar = -10,
	
	UIk1509_InfoApp_McKinney_SequesterNativeItemPicker = -11,
	UIk1509_InfoApp_McKinney_SequesterNativeItemDatePicker = -12,
	
	UIk1509_InfoApp_McKinney_SequesterNativeItemInfoLight = -13,
	UIk1509_InfoApp_McKinney_SequesterNativeItemInfoDark = -14,
	
	UIk1509_InfoApp_McKinney_SequesterNativeItemDisclosure = -15,
	
	UIk1509_InfoApp_McKinney_SequesterNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all k1509_InfoApp_McKinney_Sequester instances of
