...
/**
 Base class for all k1509_InfoApp_McKinney_Sequester views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the k1509_InfoApp_McKinney_Sequester view hierarchy (such as wrapped iOS UIViews) was touched.
