...
NSString * const TI_APPLICATION_ID = @"infoapp.mckinney.sequster";
NSString * const TI_APPLICATION_PUBLISHER = @"sequestermckinney";
NSString * const TI_APPLICATION_URL = @"http://www.3535studios.com";
NSString * const TI_APPLICATION_NAME = @"1509_InfoApp_McKinney_Sequester";
...
NSString * const TI_APPLICATION_GUID = @"bfb1167e-fd9b-4ee0-846f-440d758df470";
