...
// in simulator we redefine to format for Sandbox Developer console
...
{\
	NSString * exceptionName = [@"org.sandbox." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.sandbox";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UISandboxNativeItemNone = -1, 
	UISandboxNativeItemSpinner = -2,
	UISandboxNativeItemProgressBar = -3,
	
	UISandboxNativeItemSlider = -4,
	UISandboxNativeItemSwitch = -5,
	UISandboxNativeItemMultiButton = -6,
	UISandboxNativeItemSegmented = -7,
	
	UISandboxNativeItemTextView = -8,
	UISandboxNativeItemTextField = -9,
	UISandboxNativeItemSearchBar = -10,
	
	UISandboxNativeItemPicker = -11,
	UISandboxNativeItemDatePicker = -12,
	
	UISandboxNativeItemInfoLight = -13,
	UISandboxNativeItemInfoDark = -14,
	
	UISandboxNativeItemDisclosure = -15,
	
	UISandboxNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Sandbox instances of
