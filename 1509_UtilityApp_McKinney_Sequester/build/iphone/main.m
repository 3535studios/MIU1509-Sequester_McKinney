...
NSString * const TI_APPLICATION_ID = @"utility.app.com";
NSString * const TI_APPLICATION_PUBLISHER = @"sequestermckinney";
NSString * const TI_APPLICATION_URL = @"http://www.3535studios.com";
NSString * const TI_APPLICATION_NAME = @"1509_UtilityApp_McKinney_Sequester";
...
NSString * const TI_APPLICATION_GUID = @"b2e4efcc-4117-446a-9eee-3ad0e886d3e8";
