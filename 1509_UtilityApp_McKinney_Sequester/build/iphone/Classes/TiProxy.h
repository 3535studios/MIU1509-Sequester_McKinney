...
//Rare exceptions to indicate a bug in the _k1509_utilityapp_mckinney_sequester code (Eg, function that a subclass should have implemented)
...
/**
 The base class for k1509_UtilityApp_McKinney_Sequester proxies.
 */
