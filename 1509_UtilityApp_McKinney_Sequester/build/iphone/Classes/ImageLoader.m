...
-(void)request:(APSHTTPRequest *)request onLoad:(APSHTTPResponse *)response
{
	...
	if ([req cancelled]==NO)
	{
		...
		if (data == nil || [data length]==0)
		{
			...
			NSError *error = [NSError errorWithDomain:@"com.k1509_utilityapp_mckinney_sequester._k1509_utilityapp_mckinney_sequester.imageloader" code:1 userInfo:errorDetail];
