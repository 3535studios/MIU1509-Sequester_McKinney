 ...
 * to send analytic data that can be viewed on the k1509_UtilityApp_McKinney_Sequester Dashboard.
 *
 * For information on getting started with k1509_UtilityApp_McKinney_Sequester Platform Services,
